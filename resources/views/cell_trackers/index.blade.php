                            ...
                            <table class="table-sm table-striped w-100">
                                ...
                                @for ($i = 0; $i < $rowCount; $i++)
                                    @php
                                        ...
                                        $is_1_error = str_contains($value1, "#N/A") || str_contains($value1, "#NUM!") || str_contains($value1, "#VALUE!") ||  str_contains($value1, "#REF!") || str_contains($value1, "#DIV/0!") || str_contains($value1[0], "=");
                                        $is_2_error = str_contains($value2, "#N/A") || str_contains($value2, "#NUM!") || str_contains($value2, "#VALUE!") ||  str_contains($value2, "#REF!") || str_contains($value2, "#DIV/0!") || str_contains($value2[0], "=");
